...
# prints the name of the file if it is import into another that is being
# executed
print(__name__)
...
class Blockchain:
    ...
    def __init__(self, public_key, node_id):
        ...
        # self.__chain = [genesis_block] # self.__chain as "private"
        # self.chain property for use with getter and setter below
    ...
    #     return self.__chain[:]
    # This turns the chain attribute into a "private" property with a getter...
    # (the method below) and a setter (@chain.setter)
    # self.chain property getter automatically creates the private self.__chain
    # from outside the file, use the getter. so 'self.chain' or more likely...
    # 'self.whatevs.chain'
    ...
    def load_data(self):
        ...
        try:
            with open('blockchain-{}.txt'.format(self.node_id), mode='r') as f:
                ...
                # using self.chain for the setter to kick in and set the chain
    ...
    def get_balance(self, sender=None):
        ...
        tx_recipient = [
            [
                tx.amount for tx in block.transactions if tx.recipient ==
                participant
